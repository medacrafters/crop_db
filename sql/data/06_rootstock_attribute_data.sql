...
VALUES
  ...
  (77, 'flowers', 'white with yellow stamens, similar in size to and bloom with Myrobalan B.'),
  ...
  (170, 'alias', 'PPH1'),
  (173, 'alias', 'PPH7'),
  (178, 'flowers', 'large, showy, light pink. Fruit is intermediate between peach and almond.'),
  ...
  (179, 'flowers', 'white, similar in size to those of Reine Claude GF1380.'),
  ...
  (180, 'flowers', 'pink, nonshowy, pollen present.'),
